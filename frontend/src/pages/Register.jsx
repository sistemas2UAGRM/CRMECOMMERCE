      ...
      <div className="container mx-auto px-6 max-w-md">
        <div className="bg-white p-10 rounded-3xl shadow-xl border border-slate-100">
          ...
          <form className="space-y-6">
            <div>
              <label className="block text-slate-700 font-medium mb-2">Nombre de usuario</label>
              <div className="relative group">
                <Users className="w-5 h-5 text-slate-400 absolute left-3 top-1/2 -translate-y-1/2" />
                <input type="text" placeholder="Usuario" className="w-full pl-10 pr-3 py-2.5 border border-slate-200 rounded-xl outline-none transition-all duration-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
              </div>
            </div>
            <div>
