      ...
      <header className={`fixed w-full z-50 transition-all duration-300 ${
        ...
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <Link to="/login" className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-2.5 rounded-full font-semibold hover:shadow-lg hover:shadow-purple-500/40 transition-all duration-300 transform hover:scale-105">
              Iniciar sesión
            </Link>
          </nav>
        </div>
