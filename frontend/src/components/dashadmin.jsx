import { 
  ...
  CreditCard, Handshake, BarChart2, Bot, ClipboardList,
} from "lucide-react";
...
const sidebarItems = [
  ...
  { name: "Bitácora", icon: <FileText size={22} />, component: <div>Contenido de Bitácora</div> },
        ...
        <nav className="flex flex-col gap-4 px-2">
          {sidebarItems.map((item) => (
            <button
              ...
              className={`flex items-center justify-center md:justify-start gap-3 rounded-md px-3 py-2 text-sm font-medium transition focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#2e7e8b] focus:ring-white ${
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center space-x-5 text-gray-600">
                ...
                <User className="h-7 w-7 cursor-pointer hover:text-[#2e7e8b]" />
              </div>
            </div>
          </div>
        </header>
